...
const getFontValue = (value?: string | number) => (typeof value === 'number' ? `${value}px` : value || '96px');
...
const syncUniforms = (program: Program, props: Required<WarpTextProps>) => {
...
export default function WarpText({
  ...
  if (webglFailed) {
    return (
      <div
        className={`flex items-center justify-center font-extrabold tracking-tight text-center ${className}`}
        style={{
